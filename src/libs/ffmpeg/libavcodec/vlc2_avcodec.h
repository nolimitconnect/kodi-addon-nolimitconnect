...
#ifndef AVCODEC_VLC_H_
#define AVCODEC_VLC_H_
...
int ff_init_vlc_sparse2(VLC *vlc, int nb_bits, int nb_codes,
...
#define init_vlc(vlc, nb_bits, nb_codes,                \
                 ...
                 flags)                                 \
    ff_init_vlc_sparse2(vlc, nb_bits, nb_codes,         \
                       bits, bits_wrap, bits_size,      \
                       codes, codes_wrap, codes_size,   \
                       NULL, 0, 0, flags)
...
#define INIT_CUSTOM_VLC_SPARSE_STATIC(vlc, bits, a, b, c, d, e, f, g,      \
    ...
    do {                                                                   \
        ...
        ff_init_vlc_sparse2(vlc, bits, a, b, c, d, e, f, g, h, i, j,        \
