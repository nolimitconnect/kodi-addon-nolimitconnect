...
#if HAVE_DEV_BKTR_IOCTL_METEOR_H || HAVE_DEV_VIDEO_METEOR_IOCTL_METEOR_H || HAVE_DEV_IC_BT8XX_H
...
#endif // HAVE_DEV_BKTR_IOCTL_METEOR_H || HAVE_DEV_VIDEO_METEOR_IOCTL_METEOR_H || HAVE_DEV_IC_BT8XX_H
