...
void CDisplaySettings::SetResolutionInfo(RESOLUTION resolution, int windowWidth, int windowHeight)
{
    RESOLUTION_INFO& resInfo = GetResolutionInfo( (size_t)resolution );
    resInfo.bFullScreen = false;
    resInfo.iWidth = windowWidth;
    resInfo.iScreenWidth = windowWidth;

    resInfo.iHeight = windowHeight;
    resInfo.iScreenHeight = windowHeight;
    resInfo.iSubtitles = windowHeight;
}
