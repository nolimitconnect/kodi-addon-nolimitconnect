...
public:
  ...
  bool ProcessSelector(CGUITextureBase* background,
                       CGUITextureBase* nib,
...
protected:
  ...
  std::unique_ptr<CGUITextureBase> m_guiBackgroundDisabled;
  ...
  std::unique_ptr<CGUITextureBase> m_guiSelectorLowerDisabled;
  std::unique_ptr<CGUITextureBase> m_guiSelectorUpperDisabled;
  int m_iType;
