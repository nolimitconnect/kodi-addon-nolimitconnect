...
CGUIColorButtonControl::CGUIColorButtonControl(int parentID,
  ...
  : CGUIButtonControl(
    ...
    m_imgColorMask(CGUITextureBase::CreateTexture(posX, posY, 16, 16, colorMask)),
    m_imgColorDisabledMask(CGUITextureBase::CreateTexture(posX, posY, 16, 16, colorDisabledMask)),
