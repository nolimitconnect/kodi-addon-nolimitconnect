...
std::unique_ptr<CTextureBase> CGUIFontTTFGLES::ReallocTexture(unsigned int& newHeight)
{
  newHeight = CTextureBase::PadPow2(newHeight);

  std::unique_ptr<CTextureBase> newTexture =
      CTextureBase::CreateTexture(m_textureWidth, newHeight, XB_FMT_A8);
