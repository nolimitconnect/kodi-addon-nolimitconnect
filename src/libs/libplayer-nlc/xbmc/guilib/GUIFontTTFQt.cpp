...
{
    INlcRender::getINlcRender().firstBegin( this );
    /*
#if defined(HAS_GL)
...
// GLES 2.0 version.
    ...
    INlcRender::getINlcRender().lastEnd( this );
...
{
    return INlcRender::getINlcRender().createVertexBuffer( const_cast<CGUIFontTTFQt*>(this), vertices );
...
{
    return INlcRender::getINlcRender().destroyVertexBuffer( const_cast<CGUIFontTTFQt*>(this), buffer );
...
{
    INlcRender::getINlcRender().deleteHardwareTexture( const_cast< CGUIFontTTFQt* >( this ) );
}
...
void CGUIFontTTFQt::CreateStaticVertexBuffers( void )
{
    ...
    INlcRender::getINlcRender().createStaticVertexBuffers( &fontQt );
}
...
void CGUIFontTTFQt::DestroyStaticVertexBuffers( void )
{
    ...
    CGUIFontTTFQt fontQt( "" );
    INlcRender::getINlcRender().destroyStaticVertexBuffers( &fontQt );
