...
void CEventLog::Add(const EventPtr& eventPtr)
{
  ...
  SendLogMessage(eventPtr, GUI_MSG_EVENT_ADDED);
}
...
void CEventLog::Remove(const std::string& eventPtrIdentifier)
{
  ...
  SendLogMessage(eventPtr, GUI_MSG_EVENT_REMOVED);
}
...
void CEventLog::SendLogMessage(const EventPtr& eventPtr, int message)
{
