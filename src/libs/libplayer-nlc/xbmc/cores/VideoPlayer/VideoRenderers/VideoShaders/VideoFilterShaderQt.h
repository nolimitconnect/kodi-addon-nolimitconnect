...
namespace Shaders {
    ...
    {
    public:
        BaseVideoFilterShaderQt( INlcRender& nlcRender );
    ...
    {
    public:
        ConvolutionFilterShaderQt( INlcRender& nlcRender, ESCALINGMETHOD method );
    ...
    {
    public:
        DefaultFilterShaderQt( INlcRender& nlcRender ) : BaseVideoFilterShaderQt( INlcRender::getINlcRender() ) {}
        void OnCompiledAndLinked();
        bool OnEnabled();
    };
