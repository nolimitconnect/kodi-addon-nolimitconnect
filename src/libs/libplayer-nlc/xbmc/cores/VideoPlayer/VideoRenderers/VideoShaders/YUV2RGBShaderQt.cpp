...
//============================================================================
//============================================================================
BaseYUV2RGBShaderQt::BaseYUV2RGBShaderQt(  INlcRender& nlcRender, unsigned flags, EShaderFormat format )
: BaseYUV2RGBShader( nlcRender )
{
...
//////////////////////////////////////////////////////////////////////
//============================================================================
YUV2RGBProgressiveShaderQt::YUV2RGBProgressiveShaderQt( INlcRender& nlcRender, unsigned flags, EShaderFormat format )
    : BaseYUV2RGBShaderQt( nlcRender, flags, format )
{
...
//////////////////////////////////////////////////////////////////////
//============================================================================
YUV2RGBBobShaderQt::YUV2RGBBobShaderQt( INlcRender& nlcRender, unsigned flags, EShaderFormat format )
    : BaseYUV2RGBShaderQt( nlcRender, flags, format )
{
    //m_hStepX = -1;
    //m_hStepY = -1;
