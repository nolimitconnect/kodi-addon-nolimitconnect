...
namespace Shaders {
    ...
    {
    public:
        BaseYUV2RGBShader( INlcRender& nlcRender ) : m_INlc( INlcRender::getINlcRender() ) {};
    ...
    {
    public:
        BaseYUV2RGBShaderQt(  INlcRender& nlcRender, unsigned flags, EShaderFormat format );
        ~BaseYUV2RGBShaderQt();
    ...
    {
    public:
        YUV2RGBProgressiveShaderQt(  INlcRender& nlcRender, unsigned flags = 0,
    ...
    {
    public:
        YUV2RGBBobShaderQt( INlcRender& nlcRender, unsigned flags = 0, EShaderFormat format = SHADER_NONE );
        void                    OnCompiledAndLinked();
        bool                    OnEnabled();
        /*
        GLint                   m_hStepX;
