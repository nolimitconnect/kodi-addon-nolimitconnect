...
BaseVideoFilterShaderQt::BaseVideoFilterShaderQt( INlcRender& nlcRender )
: m_INlc( nlcRender )
{
...
ConvolutionFilterShaderQt::ConvolutionFilterShaderQt( INlcRender& nlcRender, ESCALINGMETHOD method )
    : BaseVideoFilterShaderQt( nlcRender )
{
    m_method = method;
    //m_kernelTex1 = 0;
    //m_hKernTex = -1;
