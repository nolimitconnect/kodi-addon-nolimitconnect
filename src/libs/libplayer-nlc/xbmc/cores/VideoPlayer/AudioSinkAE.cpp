...
unsigned int CAudioSinkAE::AddPackets( const DVDAudioFrame& audioframe )
{
    ...
    //if(LogEnabled(eLogAudioIo)) LogModule( eLogAudioIo, LOG_VERBOSE, " CAudioSinkAE::AddPackets frames %d duration %3.3f pts %3.3f clock %3.3f", frames, audioframe.duration, m_playingPts, m_timeOfPts );
