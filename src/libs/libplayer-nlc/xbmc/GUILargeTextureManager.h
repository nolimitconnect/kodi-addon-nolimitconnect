...
public:
  ...
  std::unique_ptr<CTextureBase> m_texture; ///< Texture object to load the image into \sa CTexture.
};
...
/*!
 ...
 \sa IJobCallback, CGUITextureBase
 */
...
public:
  ...
  /*!
   ...
   \sa CGUITextureArray and CGUITextureBase
   */
...
private:
  ...
  public:
    ...
    void SetTexture(std::unique_ptr<CTextureBase> texture);
