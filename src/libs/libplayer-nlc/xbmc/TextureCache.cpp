...
{
  return url.GetPwdUserName().empty() || url.GetPwdUserName() == "music" ||
         url.GetPwdUserName() == "video" || StringUtils::StartsWith(url.GetPwdUserName(), "video_") ||
         StringUtils::StartsWith(url.GetPwdUserName(), "pvr") ||
         StringUtils::StartsWith(url.GetPwdUserName(), "epg");
}
