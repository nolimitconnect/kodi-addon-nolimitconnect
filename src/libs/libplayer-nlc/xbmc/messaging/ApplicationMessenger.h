...
public:
   ...
   */
  void SetGUIThread(ThreadIdentifierKodi thread) { m_guiThreadId = thread; }
   ...
   */
  void SetProcessThread(ThreadIdentifierKodi thread) { m_processThreadId = thread; }
...
private:
  ...
  ThreadIdentifierKodi m_guiThreadId;
  ThreadIdentifierKodi m_processThreadId;
  bool m_bStop{ false };
};
}
}
