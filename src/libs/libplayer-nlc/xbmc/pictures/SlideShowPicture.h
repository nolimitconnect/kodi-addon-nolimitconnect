...
public:
  ...
  void UpdateTexture(std::unique_ptr<CTextureBase> pTexture);
...
protected:
  virtual void Render(float* x, float* y, CTextureBase* pTexture, UTILS::COLOR::Color color) = 0;
...
private:
  ...
  std::unique_ptr<CTextureBase> m_pImage;
